...
class ConverterSpec extends ObjectBehavior
{
    ...
    function it_converts_html_to_amp(){
        ...
        ->shouldReturn('<div><div><p>text</p><amp-img src="img.jpg" width="500" height="420" layout="responsive"></amp-img></div></div>');
    }

    function it_removes_prohibited_attributes(){
        $this->convert('<div onmousedown="event();" style="text-align:center;"><p>hh</p><a href="javascript:alert(\'Hello\');">Hello!</a></div>')
        ->shouldReturn('<div><div><p>hh</p></div></div>');
    }

    function it_converts_img_to_ampimg(){
        $this->addConverter(new AMPImg());
        
        $this->convert('<img src="/img.jpg" width="800" height="420" alt="Sample image">')
        ->shouldReturn('<div><amp-img src="/img.jpg" width="800" height="420" alt="Sample image" layout="responsive"></amp-img></div>');
        
        $this->getScripts()->shouldReturn([]);
    }

    function it_converts_img_to_ampimg_with_zoom(){

        $this->addConverter(new AMPImgZoom());
        
        $this->convert('<img src="/img.jpg" width="800" height="420" alt="Sample image">')
        ->shouldReturn('<div><amp-pan-zoom width="800" height="420" layout="responsive"><amp-img src="/img.jpg" alt="Sample image" layout="fill"></amp-img></amp-pan-zoom></div>');
    ...
    function it_converts_img_to_ampimg_with_lightbox(){
        $this->addConverter(new AMPImgLightbox());
        
        $this->convert('<img src="/img.jpg" width="800" height="420" alt="Sample image">')
        ->shouldReturn('<div><amp-img src="/img.jpg" width="800" height="420" alt="Sample image" layout="responsive" lightbox=""></amp-img></div>');
    ...
    function it_converts_youtube_videos(){
        ...
        ->shouldReturn('<div><amp-youtube data-videoid="lBTCB7yLs8Y" width="480" height="270" layout="responsive"></amp-youtube></div>');
    ...
    function it_converts_iframe_to_ampiframe(){
        ...
        ->shouldReturn('<div><amp-iframe src="https://player.vimeo.com/video/93199353?color=ff9933&amp;title=0&amp;byline=0&amp;portrait=0&amp;badge=0" sandbox="allow-scripts allow-same-origin allow-popups" width="640" height="360" allowfullscreen="" layout="responsive"></amp-iframe></div>');
    ...
    function it_converts_video_to_ampvideo(){
...
<source src="movie.ogg" type="video/ogg">
        ...
        ->shouldReturn('<div><amp-video width="320" height="240" layout="responsive" controls="">
<source src="movie.mp4" type="video/mp4">
<source src="movie.ogg" type="video/ogg">
</amp-video></div>');
    ...
    function it_converts_audio_to_ampaudio(){
...
<source src="horse.mp3" type="audio/mpeg">
        ...
        ->shouldReturn('<div><amp-audio controls="">
<source src="horse.ogg" type="audio/ogg">
<source src="horse.mp3" type="audio/mpeg">
</amp-audio></div>');
    ...
    function it_converts_fb_posts_to_ampfacebook(){
        ...
        ->shouldReturn('<div><amp-facebook width="552" height="310" layout="responsive" data-href="https://www.facebook.com/20531316728/posts/10154009990506729/" data-embed-as="post"></amp-facebook></div>');
    ...
    function it_converts_facebook_iframe_post_embed_to_ampfacebook(){
        ...
        ->shouldReturn('<div><amp-facebook width="552" height="310" layout="responsive" data-href="https://www.facebook.com/Engineering/posts/10157088947367200" data-embed-as="post"></amp-facebook></div>');
    ...
    function it_converts_facebook_iframe_video_embed_to_ampfacebook(){
        $this->addConverter(new AMPFacebook());
        ...
        ->shouldReturn('<div><amp-facebook width="552" height="310" layout="responsive" data-href="https://www.facebook.com/Engineering/videos/391155644961802/" data-embed-as="video"></amp-facebook></div>');
    ...
    function it_converts_fb_video_to_ampfacebook(){
        ...
        ->shouldReturn('<div><amp-facebook width="552" height="310" layout="responsive" data-href="https://www.facebook.com/facebook/videos/10153231379946729/" data-embed-as="video"></amp-facebook></div>');
    ...
    function it_converts_fb_comment_to_ampfacebook(){
        ...
        data-width="500"></div>')
        ->shouldReturn('<div><amp-facebook width="552" height="310" layout="responsive" data-href="https://www.facebook.com/zuck/posts/10102735452532991?comment_id=1070233703036185" data-embed-as="comment"></amp-facebook></div>');
    ...
    function it_converts_pinterest_embed_to_amppinterest(){
        ...
        ->shouldReturn('<div><amp-pinterest width="552" height="310" layout="responsive" data-url="https://www.pinterest.com/pin/99360735500167749/" data-do="embedPin"></amp-pinterest></div>');
    ...
    function it_converts_playbuzz_embed_to_ampplaybuzz(){
...
<div class="playbuzz" data-id="f2bc8619-8c50-44c3-80bb-8eda5a3497c0" data-show-share="false" data-show-info="false" data-comments="false"></div>')
        ->shouldReturn('<div>
<amp-playbuzz height="700" data-item="f2bc8619-8c50-44c3-80bb-8eda5a3497c0" data-share-buttons="true"></amp-playbuzz></div>');
    ...
    function it_converts_imgur_embeds_to_ampimgur(){
        ...
        ->shouldReturn('<div><amp-imgur data-imgur-id="XVMu7rB" width="540" height="670" layout="responsive"></amp-imgur></div>');
    ...
    function it_converts_gist_embed_to_ampgist(){
        ...
        ->shouldReturn('<div><amp-gist data-gistid="bad2044f8b7fb7c25860793f251a96b6" layout="fixed-height" height="250"></amp-gist></div>');
    ...
    function it_converts_twitter_post_embed_to_amptwitter(){
        ...
        ->shouldReturn('<div><amp-twitter width="375" height="472" layout="responsive" data-tweetid="996439497804890112"></amp-twitter></div>');
    ...
    function it_converts_instagram_post_embed_to_ampinstagram(){
        ...
        ->shouldReturn('<div><amp-instagram data-shortcode="tsxp1hhQTG" data-captioned="" width="400" height="400" layout="responsive"></amp-instagram></div>');
    ...
    function it_converts_vk_embed_to_ampvk(){
        ...
        ->shouldReturn('<div><amp-vk data-embedtype="post" data-owner-id="1" data-post-id="45616" data-hash="ZMk4b98xpQZMJJRXVsL1ig" width="500" height="300" layout="responsive"></amp-vk></div>');
